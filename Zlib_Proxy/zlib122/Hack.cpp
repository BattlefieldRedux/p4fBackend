...
void ReplaceURLs()
{
	WriteDWord(0x405258, (DWORD)&"https://github.com/Synaxis/p4fBackend");
	WriteDWord(0x405246, (DWORD)&"It appears the game client was not started properly...For more information visit the wiki at https://github.com/Synaxis/p4fBackend");
}
