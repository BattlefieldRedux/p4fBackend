...
namespace BlazeLib
{
    ...
    public static string[] DescComponent4 = {
             "1",
             "createGame",
             "2",
             "destroyGame",
    ...
    public static string[] DescComponent7 = {
             "1",
             "getStatDescs",
             "2",
             "getStats",
    ...
    public static string[] DescComponent9 = {
             "1",
             "fetchClientConfig",
             "2",
             "ping",
    ...
    public static string[] DescComponentF = {
             "1",
             "sendMessage",
             "2",
             "fetchMessages",
    ...
    public static string[] DescComponent19 = {
         "1",
         "addUsersToList",
         "2",
         "removeUsersFromList",
        ...
        public static string[] DescComponent1C = {
         "1",
         "submitGameReport",
         "2",
        ...
        public static string[] DescComponent7802 = {
         "1",
         "lookupUserInformation",
         "2",
         "lookupUsersInformation",
         "3",
         "fetchExtendedData",
         "5",
